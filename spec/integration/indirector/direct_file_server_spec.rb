...
describe Puppet::Indirector::DirectFileServer, " when interacting with the filesystem and the model" do
  ...
  it "should return an instance of the model" do
    ...
    @terminus.find(Puppet::Indirector::Request.new(:file_content, :find, "file://host#{@filepath}")).should be_instance_of(Puppet::FileServing::Content)
  end
  ...
  it "should return an instance capable of returning its content" do
    ...
    instance = @terminus.find(Puppet::Indirector::Request.new(:file_content, :find, "file://host#{@filepath}"))
...
describe Puppet::Indirector::DirectFileServer, " when interacting with FileServing::Fileset and the model" do
  before do
    ...
    @request = Puppet::Indirector::Request.new(:file_content, :search, "file:///#{@path}", :recurse => true)
  end
